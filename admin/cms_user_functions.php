...
function createUser($link, $fname, $username, $password, $email, $lvllist) {
    ...
    if ($userquery) {
        $userMsg = "<p>Hello " . $fname . ", you become a new user now. Please check your account info below:" . "</p><br/><li>User Name: " . $username . "</li>" . "<li>Password: " . $password . "</li><br/><p>Plese click <a href='http://localhost:8888/fwyllie_ledc-master/admin/login.php'>HERE</a> to login.</p>";
        //send email
